...
const ProffessionalSummary = ({ data, onChange, setResumeData }) => { 
  ...
  const generateSummary = async () =>{
    try {
      ...
      const response = await api.post('/api/ai/enhance-prof-sum', { userContent: prompt });
  ...
  return (
    <div className="space-y-4">
      <div className="flex items-center justify-between">
        ...
        <button disabled={isGenerating} onClick={generateSummary} className="flex items-center gap-2 px-3 py-1 text-sm bg-black text-purple-700 rounded hover:bg-purple-200 border transition-colors disabled:opacity-50">
 ...
 {isGenerating ? "Enhancing..." : "AI Enhance"}
      ...
      <div className="mt-6">
        <textarea
          ...
          placeholder="Write a compelling professional summary that highlights your key strents and career objectives..."
        />
