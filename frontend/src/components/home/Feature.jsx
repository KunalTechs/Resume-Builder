...
>
    <div className="flex items-center divide-x divide-gray-300 py-1 text-sm border border-gray-300 rounded-full">
        ...
        description="Our simple process helps you get your dream job by creating a professional resume in minutes with intelligent AI-powered tools and features."
      />
